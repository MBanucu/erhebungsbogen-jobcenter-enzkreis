...
\begin{Form}
  ...
  \begin{minipage}[t]{\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax}
    ...
    \vspace{20pt}
    Beziehen Sie Arbeitslosengeld oder haben es beantragt? \quad \ChoiceMenu[radio, name=arbeitslosengeld]{}{{}=nein} nein \quad \ChoiceMenu[radio, name=arbeitslosengeld]{}{{}=ja} ja seit \formline{2.5cm}
    \vspace{3pt}
  \end{minipage}%
  }
\end{Form}
...
\begin{Form}
  ...
  \begin{minipage}[t]{\dimexpr\textwidth-2\fboxsep-2\fboxrule\relax}
    ...
    \begin{tabularx}{\linewidth}{@{}Xp{3.4cm}p{2.8cm}@{}}
      Ich habe gesundheitliche Einschränkungen & \ChoiceMenu[radio, name=gesundheitlicheEinschraenkungen]{}{{}=ja} ja & \ChoiceMenu[radio, name=gesundheitlicheEinschraenkungen]{}{{}=nein} nein \\[8pt]
      Grad der Behinderung & \ChoiceMenu[radio, name=gradDerBehinderung]{}{{}=schwerbehindert} schwerbehindert & \ChoiceMenu[radio, name=gradDerBehinderung]{}{{}=gleichgestellt} gleichgestellt \\[8pt]
      Ich habe einen Antrag auf berufliche Rehabilitation gestellt. & \ChoiceMenu[radio, name=antragBeruflicheRehabilitation]{}{{}=ja} ja & \ChoiceMenu[radio, name=antragBeruflicheRehabilitation]{}{{}=nein} nein \\[8pt]
      Liegt ein Bescheid vor? & \ChoiceMenu[radio, name=bescheidVorhanden]{}{{}=ja} ja & \ChoiceMenu[radio, name=bescheidVorhanden]{}{{}=nein} nein \\[3pt]
    \end{tabularx}
    \vspace{1pt}
  \end{minipage}%
  }
...
\begin{Form}
  \begin{tblr}{
    ...
    \SetCell[c=3]{l, font=\bfseries}
      ...
      & & \\[8pt]
    \CheckBox[name=keinSchulabschluss]{}\ kein Schulabschluss & \CheckBox[name=fachhochschulreife]{}\ Fachhochschulreife & \\[4pt]
    \CheckBox[name=abschlussFoerdershule]{}\ Abschluss Förderschule & \CheckBox[name=fachabitur]{}\ Fachabitur & \\[4pt]
    \CheckBox[name=hauptschulabschluss]{}\ Hauptschulabschluss & \CheckBox[name=abitur]{}\ Abitur & \\[4pt]
    \CheckBox[name=mittlereReife]{}\ Mittlere Reife & & \\[8pt]
    \SetCell[c=3]{l}
...
\begin{Form}
  \begin{tblr}{
    width = \textwidth,
    colspec = { |c|c|X[c]|X[c]|Q[c, wd=2em]Q[c, wd=2em]| },
    row{3} = {font=\scriptsize, valign=f},
    row{4} = {rowsep = 10pt},
    row{5} = {rowsep = 10pt},
    row{6} = {rowsep = 10pt},
  }
    \hline
    \SetCell[c=6]{l, font=\bfseries}
      Angaben zu Ihrer beruflichen Aus- und Weiterbildung
    \\
    ...
    nein
    \\ \hline
    & & & & \ChoiceMenu[radio, name=abschlussOne]{}{{}=ja} & \ChoiceMenu[radio, name=abschlussOne]{}{{}=nein} \\ \hline
    & & & & \ChoiceMenu[radio, name=abschlussTwo]{}{{}=ja} & \ChoiceMenu[radio, name=abschlussTwo]{}{{}=nein} \\ \hline
    & & & & \ChoiceMenu[radio, name=abschlussThree]{}{{}=ja} & \ChoiceMenu[radio, name=abschlussThree]{}{{}=nein} \\ \hline
  \end{tblr}
\end{Form}
...
\begin{tblr}{
  ...
  \begin{Form}
    \begin{tblr}{
      ...
      & & \ChoiceMenu[radio, name=bewerbungOffenOne]{}{{}=offen} & \ChoiceMenu[radio, name=bewerbungOffenOne]{}{{}=absage} \\ \hline
      & & \ChoiceMenu[radio, name=bewerbungOffenTwo]{}{{}=offen} & \ChoiceMenu[radio, name=bewerbungOffenTwo]{}{{}=absage} \\ \hline
      & & \ChoiceMenu[radio, name=bewerbungOffenThree]{}{{}=offen} & \ChoiceMenu[radio, name=bewerbungOffenThree]{}{{}=absage} \\ \hline
      & & \ChoiceMenu[radio, name=bewerbungOffenFour]{}{{}=offen} & \ChoiceMenu[radio, name=bewerbungOffenFour]{}{{}=absage} \\ \hline
      & & \ChoiceMenu[radio, name=bewerbungOffenFive]{}{{}=offen} & \ChoiceMenu[radio, name=bewerbungOffenFive]{}{{}=absage} \\ \hline
      & & \ChoiceMenu[radio, name=bewerbungOffenSix]{}{{}=offen} & \ChoiceMenu[radio, name=bewerbungOffenSix]{}{{}=absage}
    \end{tblr}
  \end{Form}
  \\ \hline
  \begin{tblr}{
...
\begin{Form}
  \begin{tblr}{
    ...
    \\
    & \SetCell{valign = h}b)
    & Meine Mutter ist außerhalb Deutschlands (heutiges Gebiet der Bundesrepublik Deutschland) geboren und nach 1949 zugewandert.
